...
Texto vindo do manual ou baseado nele com instruções sobre o que escrever nesta seção. cite o manual TCC IFPI.
A questão de pesquisa, justificativa e objetivos devem ser diluidos no texto da introdução.
...
\subsection{TEMA INPORTANTE DE EXPLICAR 1}
\label{subsec:fundamentacao1}

Aqui voce deva escrever e citar autores que justifiquem ou que embasarão teoricamente o que pretende desenvolver citando-os com os comandos \\cite{} para uma citação no formato (Borges, 2026) ou \\citeonline{} para uma citação no formato Borges (2026).

Exemplo de um texto que exemplifica como colocar uma figura no documento. Indique que é obrigatório citar a figura no texto, usando \\autoref{} para referenciar a Figura 1.
...
Você pode usar a feramenta \textit{Tables Genetator}\footnote{https://www.tablesgenerator.com/} para criar tabelas e quadros de forma visual e depois copiar o código para o seu documento.
