...
Segundo \citeonline{marconi2017}, a área de [ÁREA DE CONHECIMENTO] tem apresentado crescente interesse por estudos que abordem [ASPECTO RELEVANTE DO TEMA]. Esta tendência evidencia a necessidade de pesquisas que contribuam para o avanço do conhecimento nesta área. Segundo \citeonline{Taigman_2014_CVPR}, é isso ai.

O presente projeto de pesquisa propõe investigar [OBJETO DE ESTUDO], com foco em [ASPECTO ESPECÍFICO A SER INVESTIGADO]. A pesquisa será desenvolvida considerando [CONTEXTO OU DELIMITAÇÃO DO ESTUDO], o que permitirá uma análise aprofundada do fenômeno em questão \cite{10.1371/journal.pone.0257923,Taigman_2014_CVPR}.
